...
mask_dimension_level = 1


slides_folder_dir = r'G:\WSI\data\病例1-15-00734\结肠癌重合示例'
slide_paths = glob.glob(os.path.join(slides_folder_dir, '*.ndpi'))  # change the surfix '.tif' to other if necessary
save_folder_dir = r'G:\WSI\data\病例1-15-00734\patch'
...
def Thread_PatchFromSlides(args):
    ...
    print('当前Slide:{}'.format(slideName))
...
def main():
    ...
    tSlidePath = r'H:\Federal Learning\data\CAMELYON16\testing\images\test_096.tif'
    slideName = 'tumor_096'
    print('当前Slide:'.format(tSlidePath))
